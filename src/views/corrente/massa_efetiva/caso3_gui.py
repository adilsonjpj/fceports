...
from libs.dynamics_lib import solver_engastada_livre
...
def caso3_gui(win):    
    ...
    lbl_title = tk.Label(
        app, 
        text = 'MASSA EFETIVA - ENGASTADA-LIVRE',
    ...
    def draw_results():
        ...
        m = solver_engastada_livre(mL=mL, L=L, superior=superior, inferior=inferior)
