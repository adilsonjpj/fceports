...
from libs.currents_lib import solver_strouhal
from PIL import Image, ImageTk

def strouhal_gui(win):    
    app = tk.Toplevel(win)    
    ...
    image = Image.open("img/equacao_strouhal.png")
    ...
    def draw_results():
        ...
        D = float(ety_D.get())
        Uo = float(ety_Uo.get())
        S = solver_strouhal(fk=fk, D=D, Uo=Uo)
