...
from libs.wave_wall_effect import solver_forca_onda_arrebentacao_parede
...
def arrebentacao_parede_gui(win):    
    ...
    def draw_results():
        ...
        ds = float(ety_ds.get())
        Ft = solver_forca_onda_arrebentacao_parede(Cp=cp, gama_agua=gamma_agua, ds=ds)
        lbl_resultado.configure(text='Ft = ' + str(round(Ft, 2)) + ' kN/m')
